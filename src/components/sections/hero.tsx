...
function HeroTitles() {
  return (
    <div className="flex w-full max-w-4xl flex-col space-y-4 overflow-hidden pt-4">
      <motion.h1
        className="bg-gradient-to-br from-foreground from-30% to-foreground/40 bg-clip-text text-center text-2xl font-medium leading-tight tracking-tighter text-transparent sm:text-5xl md:text-6xl lg:text-7xl whitespace-normal px-4 sm:px-6 md:px-8 lg:px-10 max-w-[90vw] mx-auto"
      ...
      >
        1000 Hari All-In Dapet Income 100 Juta.
      </motion.h1>
      <motion.p
        className="mb-8 text-base tracking-tight text-muted-foreground md:text-lg text-balance text-center"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 0.4,
      ...
      >
        Aku bakal share secretnya dan bantu kalian dapetin hal yang sama! Bangun bisnismu sendiri sambil membantu melindungi orang-orang terdekatmu dengan asuransi.
      </motion.p>
    </div>
  );
}
      ...
      >
        ...
        <div className="mt-6 flex flex-col items-center justify-center">
          <p className="text-xs text-muted-foreground mb-4">
            Memiliki Blueprint bisnis yang jelas, tanpa janji palsu
          </p>
          <div className="flex flex-col items-center">
            <AvatarCircles
              ...
              className="mb-2 scale-75"
            />
            <p className="text-xs text-muted-foreground">
              Join 48+ exclusive members.
            </p>
          </div>
        </div>
      </motion.div>
