    ...
    <div className="relative overflow-hidden w-full">
      ...
      <div className="relative z-10 py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          <button 
            onClick={prevSlide} 
            className="absolute top-1/2 -left-16 transform -translate-y-1/2 bg-background/80 p-3 rounded-full shadow-lg"
          >
            <ChevronLeft className="w-8 h-8" />
          </button>
          <button 
            onClick={nextSlide} 
            className="absolute top-1/2 -right-16 transform -translate-y-1/2 bg-background/80 p-3 rounded-full shadow-lg"
          >
