  ...
  return (
    <div className={cn("flex flex-col lg:flex-row items-start w-full mb-12 lg:mb-20", reverse ? "lg:flex-row-reverse" : "")}>
      <div className="w-full lg:w-[40%] mb-6 lg:mb-0 lg:px-4">
        <h3 className="text-2xl lg:text-3xl font-semibold mb-3 bg-gradient-to-r from-blue-500 via-purple-500 to-red-500 bg-clip-text text-transparent">{title}</h3>
        <p className="text-lg lg:text-xl text-muted-foreground">{description}</p>
      </div>
      <div className="w-full lg:w-[20%] flex flex-row lg:flex-col items-center justify-start mb-6 lg:mb-0 lg:px-4">
        <div className="text-4xl lg:text-5xl font-bold mr-3 lg:mr-0 lg:mb-3">{number}</div>
    ...
    <div className="relative overflow-hidden w-full">
      ...
      <div className="relative z-10 py-16 lg:py-20">
        <div className="text-center mb-10">
          ...
          <motion.p
            className="text-lg lg:text-l text-muted-foreground max-w-3xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="text-center mt-12 lg:mt-16">
          ...
          <motion.button
            className="px-10 py-4 bg-blue-600 text-white text-xl rounded-full font-semibold hover:bg-blue-700 transition-colors"
